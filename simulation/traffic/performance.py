...
class Performance:
    ...
    def __init__(self, N=1000):
        ...
        if Path(__file__).parent.parent.parent.resolve().joinpath('./data/BADA/BADA.GPF').is_file():
            GPF = np.genfromtxt(Path(__file__).parent.parent.parent.resolve().joinpath('./data/BADA/BADA.GPF'), delimiter=[3,16,8,17,29,12], dtype="U2,U15,U7,U16,U29,f8", comments="CC", autostrip=True, skip_footer=1)
    ...
    def add_aircraft(self, icao, n, mass_class=2):
        ...
        OPF = np.genfromtxt(Path(__file__).parent.parent.parent.resolve().joinpath('./data/BADA/', file_name+'.OPF'), delimiter=[3,2,2,13,13,13,13,11], dtype="U2,U1,U2,f8,f8,f8,f8,f8", comments="CC", autostrip=True, skip_header=16, skip_footer=1)
        ...
        OPF_Actype = np.genfromtxt(Path(__file__).parent.parent.parent.resolve().joinpath('./data/BADA/', file_name+'.OPF'), delimiter=[5,15,1,12,26,1], dtype="U2,U6,i1,U7,U9,U1", comments="CC", autostrip=True, max_rows=1)
        ...
        APF = np.genfromtxt(Path(__file__).parent.parent.parent.resolve().joinpath('./data/BADA/', file_name+'.APF'), delimiter=[6,8,9,4,4,4,3,5,4,4,4,4,3,4,4,5,4,4,4,5,7], dtype="U2,U7,U7,U2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,i2,U6", comments="CC", autostrip=True)
