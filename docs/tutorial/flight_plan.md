...
In the add aircraft section of the init function of the `FullFlightDemo` class, the aircraft with callsign (FULL) is created. For the details of each parameter, you may reference [this section](./creating_env.md#2-add-aircraft).
...
<!-- lineno-start: 20 -->
```py title="airtrafficsim_data/environment/FullFlightDemo.py" hl_lines="2 6 7 8 9"
# Add aircraft
